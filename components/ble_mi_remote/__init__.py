...
BleMiRemoteConnectWakeAction = ble_mi_remote_ns.class_(ACTION_CONNECT_WAKE_CLASS, automation.Action)
...
BleMiRemotePlainAdvertAction = ble_mi_remote_ns.class_(ACTION_PLAIN_ADVERT_CLASS, automation.Action)
